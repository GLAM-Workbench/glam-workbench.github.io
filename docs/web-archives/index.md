...
### [:material-notebook-outline: Timegates, Timemaps, and Mementos](timegates-timemaps-mementos.md)
...
### [:material-notebook-outline: Exploring the Internet Archive's CDX API](exploring-ia-cdx-api.md)
...
### [:material-notebook-outline: Comparing CDX APIs](comparing-cdx-apis.md)
...
### [:material-notebook-outline: Timemaps vs CDX APIs](timemaps-vs-cdx.md)
...
### [:material-notebook-outline: Get the archived version of a page closest to a particular date](get-memento.md)
...
### [:material-notebook-outline: Find all the archived versions of a web page](get-all-versions.md)
...
### [:material-notebook-outline: Harvesting collections of text from archived web pages](harvesting-text.md)
...
### [:material-notebook-outline: Harvesting data about a domain using the IA CDX API](harvesting-domain-data.md)
...
### [:material-notebook-outline: Find and explore Powerpoint presentations from a specific domain](exploring-powerpoints.md)
...
### [:material-notebook-outline: Exploring subdomains in the whole of gov.au](exploring-govau-subdomains.md)
...
### [:material-notebook-outline: Compare two versions of an archived web page](compare-page-versions.md)
...
### [:material-notebook-outline: Observing change in a web page over time](observing-change-over-time.md)

This notebook explores what we can find when you look at all captures of a single page over time.

### [:material-notebook-outline: Create and compare full page screenshots from archived web pages](create-screenshots.md)
...
### [:material-notebook-outline: Using screenshots to visualise change in a page over time](create-screenshots-over-time.md)
...
### [:material-notebook-outline: Display changes in the text of an archived web page over time](display-changes-in-text.md)
...
### [:material-notebook-outline: Find when a piece of text appears in an archived web page](find-when-text-appears.md)
...
### [:material-database-outline: Harvest of unique urls from the gov.au domain](harvest-of-govau-subdomains.md)

This is a dataset of (mostly unique) urls in the gov.au domain harvested using the IA CDX API.

### [:material-database-outline: Unique subdomains of gov.au split into components](govau-subdomains-split.md)

This is a dataset of unique subdomains within the gov.au domain.

### [:material-database-outline: Unique subdomains of gov.au in SURT format](govau-subdomains-surt.md)

This is a dataset of unique subdomains within the gov.au domain.

### [:material-folder-text-outline: Circular dendrograms of gov.au subdomains](govau-subdomains-visualisations.md)
